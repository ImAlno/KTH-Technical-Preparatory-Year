(function (root, factory) {
  ...
  const PRIMARY_ROWS = [
    ...
    { family: "formation", rotationElement: "iron", context: "Järnfilspån och svavel reagerar i rätt proportion och bildar järn(II)sulfid.", equation: "Fe(s) + S(s) -> FeS(s)", inputFormula: "Fe", inputAtoms: { Fe: 1 }, inputCoefficient: 1, inputMassG: 35.2, outputFormula: "FeS", outputAtoms: { Fe: 1, S: 1 }, outputCoefficient: 1 },
