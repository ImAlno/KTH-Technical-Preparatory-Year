(function (root, factory) {
  ...
  function dynamicsSvg(id, family, row) {
    ...
    if (family === "inclined-plane") {
      ...
      drawing = '<line x1="65" y1="135" x2="365" y2="135" stroke="#1d1d1f" stroke-width="4"/><rect x="145" y="80" width="85" height="55" fill="#dbeafe" stroke="#1d1d1f"/><circle cx="365" cy="105" r="30" fill="#f5f5f7" stroke="#1d1d1f"/><path d="M230 105 L365 105 A30 30 0 0 1 395 135 L395 160" fill="none" stroke="#0071e3" stroke-width="4"/><rect x="360" y="160" width="70" height="48" fill="#dbeafe" stroke="#1d1d1f"/><text x="120" y="55">m₁ = ' + clean(p.tableMassKg) + ' kg, μ = ' + clean(p.frictionCoefficient) + '</text><text x="355" y="232">m₂ = ' + clean(p.hangingMassKg) + " kg</text>";
